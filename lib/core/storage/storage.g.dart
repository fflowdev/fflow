...
class $AppSettingsTableTable extends AppSettingsTable
    with TableInfo<$AppSettingsTableTable, AppSettingsData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
...
class AppSettingsData extends DataClass implements Insertable<AppSettingsData> {
  ...
  AppSettingsData copyWith({String? key, DriftAny? value}) =>
      AppSettingsData(key: key ?? this.key, value: value ?? this.value);
  AppSettingsData copyWithCompanion(AppSettingsTableCompanion data) {
    return AppSettingsData(
...
class AppSettingsTableCompanion extends UpdateCompanion<AppSettingsData> {
...
typedef $$AppSettingsTableTableProcessedTableManager =
    ProcessedTableManager<
      ...
      (
        AppSettingsData,
        BaseReferences<_$AppDatabase, $AppSettingsTableTable, AppSettingsData>,
      ),
      AppSettingsData,
      PrefetchHooks Function()
    >;
